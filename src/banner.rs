...
pub fn print_banner() {
    ...
    println!("{c_brd}│{c_rst} {c_met}{:<70} {c_brd}│{c_rst}", header_content);
    println!("{c_brd}└────────────────────────────────────────────────────────────────────────┘{c_rst}");
...
╚═╝  ╚═╝ ╚═════╝ ╚═╝  ╚═╝╚═╝  ╚═╝      ╚══════╝╚═╝     ╚═╝ ╚═════╝╚══════╝"#;
    ...
    println!("\n{c_id}>> SYSTEM:{c_rst} {c_val}An Archiving Engine for EPICS-based Scientific Control Systems{c_rst}\n");
    ...
    println!("{c_ok}●{c_rst} {c_val}SYSTEM_READY{c_rst} {c_met}v{version} | MIT License | Auth: C. Krawiec{c_rst}\n");
}